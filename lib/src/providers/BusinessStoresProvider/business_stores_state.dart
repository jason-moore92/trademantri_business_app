...
class BusinessStoresState extends Equatable {
  ...
  factory BusinessStoresState.init() {
    return BusinessStoresState(
      progressState: 0,
      message: "",

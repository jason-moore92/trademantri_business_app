...
class CatalogCategoryBottomSheetDialog {
  static show(
        ...
        return Consumer<RefreshProvider>(builder: (context, refreshProvider, _) {
          ...
          for (var i = 0; i < productCatalogCategoryList!.length; i++) {
            if (_controller.text.trim().isNotEmpty &&
                productCatalogCategoryList[i].toString().toLowerCase().contains(_controller.text.trim().toLowerCase())) {
                              ...
                              return Column(
                                children: [
                                  ListTile(
                                    ...
                                    leading: IconButton(
                                      icon: Icon(
                                        _selectedCategory == _productCatalogCategoryList[index]
                                      ...
                                      onPressed: () {
                                        if (_selectedCategory == _productCatalogCategoryList[index]) {
                                          _selectedCategory = "";
                                        } else {
                                          _selectedCategory = _productCatalogCategoryList[index];
                                        }

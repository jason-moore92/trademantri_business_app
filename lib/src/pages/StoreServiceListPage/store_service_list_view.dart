...
import 'Components/catalog_services_panel.dart';
import 'index.dart';

class StoreServiceListView extends StatefulWidget {
  StoreServiceListView({Key? key}) : super(key: key);

  @override
  _StoreServiceListViewState createState() => _StoreServiceListViewState();
}

class _StoreServiceListViewState extends State<StoreServiceListView> with SingleTickerProviderStateMixin {

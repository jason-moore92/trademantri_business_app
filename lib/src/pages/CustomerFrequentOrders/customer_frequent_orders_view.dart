...
class CustomerFrequentOrdersView extends StatefulWidget {
  CustomerFrequentOrdersView({Key? key}) : super(key: key);

  @override
  _CustomerFrequentOrdersViewState createState() => _CustomerFrequentOrdersViewState();
}

class _CustomerFrequentOrdersViewState extends State<CustomerFrequentOrdersView> with SingleTickerProviderStateMixin {
  ...
  CustomerFrequentOrdersProvider? _provider;
  ...
  void initState() {
    ...
    _provider = CustomerFrequentOrdersProvider.of(context);
    _refreshController = RefreshController();

    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) {
      _provider!.init();
      if (!_provider!.state.isLoading) {
        _provider!.getData(storeId: AuthProvider.of(context).authState.storeModel!.id);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CustomerFrequentOrdersProvider>(builder: (context, provider, _) {
        return Container(
          width: deviceWidth,
          height: deviceHeight,
  ...
  Widget _bodyPanel() {
    ...
    List<CustomerFrequentOrder>? cfos = _provider!.state.cfos;
      ...
      child: SmartRefresher(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            CustomerFrequentOrder cfo = cfos[index - 1];
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      "${cfo.user!.firstName!} ${cfo.user!.lastName!}",
                      style: TextStyle(
                        color: Colors.black,
                      ),
                    ),

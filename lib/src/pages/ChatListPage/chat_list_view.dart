...
class _ChatListViewState extends State<ChatListView> with SingleTickerProviderStateMixin {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: TabBarView(
                        ...
                        children: [
                          _customerChatUsersPanel(),
                          _businessChatUsersPanel(),
                        ],
                      ),
                    ),
                  ],
  ...
  Widget _searchField() {
    return KeicyTextFormField(
      ...
      hintText: _tabController!.index == 0 ? "Search for customer" : "Search for store",
      ...
      builder: (context, snapshot) {
        ...
        if (snapshot.hasData) {
          for (var i = 0; i < snapshot.data!.length; i++) {
            if (snapshot.data![i]["firstUserData"]["_id"] != AuthProvider.of(context).authState.storeModel!.id &&
            ...
            } else if (snapshot.data![i]["firstUserData"]["_id"] == AuthProvider.of(context).authState.storeModel!.id &&
                              ...
                              children: [
                                ...
                                Slidable(
                                  ...
                                  child: ChatUserWidget(
                                    ...
                                    isFirstUser: chatRoomModel.firstUserData!["_id"] != AuthProvider.of(context).authState.storeModel!.id,
                                  ),
  ...
  Widget _businessChatUsersPanel() {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: ChatRoomFirestoreProvider.getChatRoomsStream(
        chatRoomType: ChatRoomTypes.b2b,
        storeId: AuthProvider.of(context).authState.storeModel!.id,

...
class StoreJobPostingDetailView extends StatefulWidget {
  ...
  StoreJobPostingDetailView({Key? key, this.isNew, this.storeJobPostModel}) : super(key: key);
...
class _StoreJobPostingDetailViewState extends State<StoreJobPostingDetailView> with SingleTickerProviderStateMixin {
  ...
  StoreJobPostModel? _storeJobPostModel;
  ...
  void initState() {
    ...
    _storeJobPostModel = StoreJobPostModel();

    if (_isNew!) {
      _storeJobPostModel!.jobType = "Full Time";
      _storeJobPostModel!.listonline = true;
      _storeJobPostModel!.skills = [];
      _storeJobPostModel!.status = AppConfig.jobStatusType.first["value"];
    } else if (!_isNew! && widget.storeJobPostModel != null) {
      _storeJobPostModel = StoreJobPostModel.copy(widget.storeJobPostModel!);

      _titleController.text = _storeJobPostModel!.jobTitle!;
      _descriptionController.text = _storeJobPostModel!.description!;
      _peopleNumberController.text = _storeJobPostModel!.peopleNumber!.toString();
      _minYearExperienceController.text = _storeJobPostModel!.minYearExperience!.toString();
      _startDate = _storeJobPostModel!.startDate;
      _startDateController.text = KeicyDateTime.convertDateTimeToDateString(
        dateTime: _startDate,
        isUTC: false,
      );
      if (_storeJobPostModel!.endDate != null) {
        _endDate = _storeJobPostModel!.endDate;
        _endDateController.text = KeicyDateTime.convertDateTimeToDateString(
          dateTime: _endDate,
          isUTC: false,
        );
      }
      _salaryFromController.text = _storeJobPostModel!.salaryFrom!.toString();
      _salaryToController.text = _storeJobPostModel!.salaryTo!.toString();
      _benefitsController.text = _storeJobPostModel!.benefits!;
    }
  ...
  void _jobPostHandler() async {
    ...
    _storeJobPostModel!.storeId = _authProvider!.authState.storeModel!.id;

    var result;
    if (_isNew!) {
      _storeJobPostModel!.location = _authProvider!.authState.storeModel!.location;
      result = await _storeJobPostingsProvider!.addJobPosting(jobPostData: _storeJobPostModel!.toJson());
    } else {
      _storeJobPostModel!.location = _authProvider!.authState.storeModel!.location;
      result = await _storeJobPostingsProvider!.updateJobPosting(jobPostData: _storeJobPostModel!.toJson());
    }
    await _keicyProgressDialog!.hide();

    if (result["success"]) {
      SuccessDialog.show(context, heightDp: heightDp, fontSp: fontSp);
      _storeJobPostModel!.id = result["data"]["_id"];
      _isNew = false;
      _isUpdatedData = {
        "isUpdated": true,
        "jobPostingData": _storeJobPostModel!.toJson(),
      };
      setState(() {});
    } else {
      ErrorDialog.show(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    KeicyTextFormField(
                      ...
                      onSaveHandler: (input) => _storeJobPostModel!.jobTitle = input.trim(),
                    ...
                    KeicyTextFormField(
                      ...
                      onSaveHandler: (input) => _storeJobPostModel!.description = input.trim(),
                    ...
                    KeicyTextFormField(
                      ...
                      onSaveHandler: (input) => _storeJobPostModel!.peopleNumber = int.parse(input.trim()),
                    ...
                    KeicyTextFormField(
                      ...
                      onSaveHandler: (input) => _storeJobPostModel!.minYearExperience = int.parse(input.trim()),
                      ...
                      children: [
                        Expanded(
                          child: Row(
                            children: [
                              Radio(
                                groupValue: _storeJobPostModel!.jobType,
                                value: "Full Time",
                                onChanged: (String? value) {
                                  _storeJobPostModel!.jobType = value;
                                  setState(() {});
                                },
                              ),
                              Expanded(
                      ...
                      children: [
                        Expanded(
                          child: KeicyTextFormField(
                            ...
                            onSaveHandler: (input) => _storeJobPostModel!.startDate = _startDate,
                            onFieldSubmittedHandler: (input) => FocusScope.of(context).requestFocus(FocusNode()),
                          ),
                        ),
                        ...
                        Expanded(
                          child: KeicyTextFormField(
                            ...
                            onSaveHandler: (input) {
                              ...
                              _storeJobPostModel!.endDate = _endDate;
                            },
                            onFieldSubmittedHandler: (input) => FocusScope.of(context).requestFocus(FocusNode()),
                          ),
                        ),
                      ...
                      children: [
                        Expanded(
                          child: KeicyTextFormField(
                            ...
                            onSaveHandler: (input) => _storeJobPostModel!.salaryFrom = double.parse(input.trim()),
                        ...
                        Expanded(
                          child: KeicyTextFormField(
                            ...
                            onSaveHandler: (input) => _storeJobPostModel!.salaryTo = double.parse(input.trim()),
                            onFieldSubmittedHandler: (input) => FocusScope.of(context).requestFocus(FocusNode()),
                          ),
                        ),
                        SizedBox(width: widthDp * 5),
                        Expanded(
                          child: KeicyDropDownFormField(
                            width: double.infinity,
                            height: heightDp * 40,
                            value: _storeJobPostModel!.salaryType,
                            ...
                            onChangeHandler: (value) {
                              _storeJobPostModel!.salaryType = value;
                              setState(() {});
                            },
                          ),
                        ),
                    ...
                    Wrap(
                      ...
                      children: List.generate(_storeJobPostModel!.skills!.length, (index) {
                        if (index >= _storeJobPostModel!.skills!.length) {
                          return KeicyTextFormField(
                            ...
                            // errorStringFontSize: fontSp * 10,
                            validatorHandler: (input) {
                              if (_storeJobPostModel!.skills == null || _storeJobPostModel!.skills!.isEmpty) return "Please enter skill";

                              return null;
                            },
                            onFieldSubmittedHandler: (input) {
                              if (_storeJobPostModel!.skills == null) _storeJobPostModel!.skills = [];
                              bool isNew = true;
                              for (var i = 0; i < _storeJobPostModel!.skills!.length; i++) {
                                if (_storeJobPostModel!.skills![i].toString().toLowerCase() == input.trim().toLowerCase()) {
                                  isNew = false;
                                  break;
                                }
                              }
                              if (isNew) {
                                _storeJobPostModel!.skills!.add(input.trim());
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        _storeJobPostModel!.skills![index],
                                        style: TextStyle(fontSize: fontSp * 16, color: Colors.black),
                                      ),
                                    ],
                                  ),
                                ...
                                GestureDetector(
                                  onTap: () {
                                    _storeJobPostModel!.skills!.removeAt(index);
                                    setState(() {});
                                  },
                                  child: Container(
                                    height: heightDp * 40,
                    ...
                    KeicyTextFormField(
                      ...
                      onSaveHandler: (input) => _storeJobPostModel!.benefits = input.trim(),
                      onFieldSubmittedHandler: (input) => FocusScope.of(context).requestFocus(FocusNode()),
                    ),
                      ...
                      Column(
                        children: [
                          ...
                          KeicyDropDownFormField(
                            width: double.infinity,
                            height: heightDp * 40,
                            value: _storeJobPostModel!.status,
                            ...
                            onChangeHandler: (value) {
                              _storeJobPostModel!.status = value;
                              setState(() {});
                            },
                          ),
                        ],
                    ...
                    Row(
                      children: [
                        KeicyCheckBox(
                          ...
                          value: _storeJobPostModel!.listonline!,
                          onChangeHandler: (value) {
                            _storeJobPostModel!.listonline = value;
                            setState(() {});
                          },
                          onSaveHandler: (value) => _storeJobPostModel!.listonline = value,
                        ),
                      ],
                    ),

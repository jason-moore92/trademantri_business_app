...
class OrderDetailNewPage extends StatefulWidget {
  ...
  @override
  _OrderDetailNewPageState createState() => _OrderDetailNewPageState();
}

class _OrderDetailNewPageState extends State<OrderDetailNewPage> {
  @override
  Widget build(BuildContext context) {
            ...
            switch (snapshot.connectionState) {
              ...
              case ConnectionState.done:
                if (snapshot.hasData && snapshot.data["success"] && snapshot.data["data"].isNotEmpty) {
                  return OrderDetailNewView(orderModel: OrderModel.fromJson(snapshot.data["data"][0]));
    ...
    return OrderDetailNewView(orderModel: widget.orderModel);
  }
}

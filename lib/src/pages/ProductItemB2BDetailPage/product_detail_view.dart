...
class _ProductDetailViewState extends State<ProductDetailView> {
  ...
  void initState() {
    ...
    reviewKey = "${widget.storeModel!.id}_${widget.productModel!.id}_${widget.type}";
  ...
  Widget _priceWidget() {
    if (widget.productModel!.b2bPriceFrom == 0 && widget.productModel!.b2bPriceTo == 0)
      return Text(
        "Price Not Available",
        style: TextStyle(fontSize: fontSp * 14, color: Colors.red, fontWeight: FontWeight.w500),
      );

    return widget.productModel!.b2bDiscount == null || widget.productModel!.b2bDiscount == 0
        ? Text(

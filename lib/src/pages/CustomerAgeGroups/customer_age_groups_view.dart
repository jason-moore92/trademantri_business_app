...
class CustomerAgeGroupsView extends StatefulWidget {
  CustomerAgeGroupsView({Key? key}) : super(key: key);

  @override
  _CustomerAgeGroupsViewState createState() => _CustomerAgeGroupsViewState();
}

class _CustomerAgeGroupsViewState extends State<CustomerAgeGroupsView> with SingleTickerProviderStateMixin {
  ...
  CustomerAgeGroupsProvider? _provider;
  ...
  void initState() {
    ...
    _provider = CustomerAgeGroupsProvider.of(context);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CustomerAgeGroupsProvider>(builder: (context, provider, _) {
        return Container(
          width: deviceWidth,
          height: deviceHeight,
  ...
  Widget _bodyPanel() {
    ...
    List<CustomerAgeGroup>? groups = _provider!.state.groups;
    ...
    if (groups.length == 0 || !_provider!.checkData(groups)) {
      return Center(
        child: Text(

...
class TopSellingProductsView extends StatefulWidget {
  final UserModel? user;
  TopSellingProductsView({Key? key, this.user}) : super(key: key);

  @override
  _TopSellingProductsViewState createState() => _TopSellingProductsViewState();
}

class _TopSellingProductsViewState extends State<TopSellingProductsView> with SingleTickerProviderStateMixin {
  ...
  TopSellingProductsProvider? _provider;
  ...
  void initState() {
    ...
    _provider = TopSellingProductsProvider.of(context);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Text(
              widget.user == null ? "Top Selling Products" : "Products bought by",
      ...
      body: Consumer<TopSellingProductsProvider>(builder: (context, provider, _) {
        return Container(
          width: deviceWidth,
          height: deviceHeight,
  ...
  Widget _bodyPanel() {
    ...
    List<TopSellingProduct>? tsps = _provider!.state.tsps;
      ...
      child: SmartRefresher(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            TopSellingProduct tsp = tsps[index - 1];

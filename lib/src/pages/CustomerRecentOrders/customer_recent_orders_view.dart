...
class CustomerRecentOrdersView extends StatefulWidget {
  ...
  CustomerRecentOrdersView({
    Key? key,
    this.user,
  }) : super(key: key);

  @override
  _CustomerRecentOrdersViewState createState() => _CustomerRecentOrdersViewState();
}

class _CustomerRecentOrdersViewState extends State<CustomerRecentOrdersView> with SingleTickerProviderStateMixin {
  ...
  CustomerRecentOrdersProvider? _provider;
  ...
  void initState() {
    ...
    _provider = CustomerRecentOrdersProvider.of(context);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<CustomerRecentOrdersProvider>(builder: (context, provider, _) {
        return Container(
          width: deviceWidth,
          height: deviceHeight,

...
//   final Function(Map<String, dynamic>?)? refreshCallback;
...
//                 ],
//               ),
//               (widget.serviceData!["taxPrice"] == 0 && widget.serviceData!["provided"] == null)
//                   ? SizedBox(width: widthDp * 5)
//                   : Column(
//                       children: [
...
//                                     children: [
//                                       Text(
//                                         "Tax: ₹ ${(widget.serviceData!["taxPrice"] * widget.serviceData!["orderQuantity"]).toStringAsFixed(2)}",
...
//       children: [
//         widget.deleteCallback == null || widget.orderData!["status"] != AppConfig.orderStatusData[1]["id"]
//             ? SizedBox()
//             : GestureDetector(
...
//               GestureDetector(
//                 onTap: () async {
//                   if (widget.orderData!["status"] != AppConfig.orderStatusData[1]["id"]) return;
//                   if (widget.serviceData!["orderQuantity"] == 1) return;
...
//                     fontSp: fontSp,
//                     callBack: () {
//                       widget.serviceData!["orderQuantity"] = widget.serviceData!["orderQuantity"] - 1;
//                       widget.refreshCallback!(widget.orderData);
//                       setState(() {});
//                     },
//                   );
//                 },
...
//                             color: (widget.orderData!["status"] != AppConfig.orderStatusData[1]["id"] || widget.serviceData!["orderQuantity"] == 1)
//                                 ? Colors.grey
...
//             mainAxisAlignment: MainAxisAlignment.end,
//             children: [
//               if (widget.serviceData!["_id"] == null && widget.orderData!["status"] == AppConfig.orderStatusData[1]["id"])
//                 _editPriceButton()
//               else
//                 SizedBox(),
//               if (widget.serviceData!["promocodeDiscount"] == 0)
//                 Text(
//                   "₹ ${((widget.serviceData!["price"] - widget.serviceData!["discount"]) * widget.serviceData!["orderQuantity"]).toStringAsFixed(2)}",
...
//                   children: [
//                     Text(
//                       "₹ ${((widget.serviceData!["price"] - widget.serviceData!["discount"] - widget.serviceData!["promocodeDiscount"]) * widget.serviceData!["orderQuantity"]).toStringAsFixed(2)}",
//                       style: TextStyle(fontSize: fontSp * 16, color: config.Colors().mainColor(1), fontWeight: FontWeight.w500),
//                     ),
...
//     if (widget.orderData!["status"] == AppConfig.orderStatusData[7]["id"] || widget.orderData!["status"] == AppConfig.orderStatusData[8]["id"])
//       return SizedBox();

//     return GestureDetector(
//       onTap: () {
//         ProductPriceDialog.show(context, productData: widget.serviceData, callback: (Map<String, dynamic> serviceData) {

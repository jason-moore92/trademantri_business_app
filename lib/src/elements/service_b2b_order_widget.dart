...
// class ServiceB2BOrderWidget extends StatefulWidget {
...
//   @override
//   _ServiceB2BOrderWidgetState createState() => _ServiceB2BOrderWidgetState();
// }

// class _ServiceB2BOrderWidgetState extends State<ServiceB2BOrderWidget> {
...
//       children: [
//         widget.deleteCallback == null || widget.b2bOrderModel!.status != AppConfig.orderStatusData[1]["id"]
//             ? SizedBox()
//             : GestureDetector(
...
//               GestureDetector(
//                 onTap: () async {
//                   if (widget.b2bOrderModel!.status != AppConfig.orderStatusData[1]["id"]) return;
...
//                             color:
//                                 (widget.b2bOrderModel!.status != AppConfig.orderStatusData[1]["id"] || widget.serviceOrderModel!.couponQuantity == 1)
//                                     ? Colors.grey
...
//             children: [
//               if (widget.serviceOrderModel!.serviceModel!.id == null && widget.b2bOrderModel!.status == AppConfig.orderStatusData[1]["id"])
//                 _editPriceButton()
//               else
//                 SizedBox(),
...
//     if (widget.b2bOrderModel!.status == AppConfig.orderStatusData[7]["id"] || widget.b2bOrderModel!.status == AppConfig.orderStatusData[8]["id"])
//       return Text(
//         "Price Not Available",

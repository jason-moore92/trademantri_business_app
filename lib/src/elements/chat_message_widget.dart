...
class _BargainRequestWidgetState extends State<ChatMessageWidget> {
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    if (widget.chatModel!.messageType == MessageType.invoice) _invoiceWidget(),
                    ...
                    if (widget.chatModel!.messageType == MessageType.b2bInvoice) _b2bInvoiceWidget(),
                  ],
                ),
  ...
  Widget _couponWidget() {
    ...
    /// percent
    if (widget.chatModel!.additionalData['discountType'] == AppConfig.discountTypeForCoupon[0]["value"]) {
      discountWidget = Wrap(
        crossAxisAlignment: WrapCrossAlignment.end,
        children: [
          Text(
            "${widget.chatModel!.additionalData["discountData"]["discountValue"]} % ",
            style: TextStyle(
              fontSize: fontSp! * 14,
    ...
    // fix amount
    else if (widget.chatModel!.additionalData["discountType"] == AppConfig.discountTypeForCoupon[1]["value"]) {
      discountWidget = Wrap(
        crossAxisAlignment: WrapCrossAlignment.end,
        children: [
          Text(
    ...
    // BOGO
    else if (widget.chatModel!.additionalData["discountType"] == AppConfig.discountTypeForCoupon[2]["value"]) {
      discountWidget = Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
            "Buy ${widget.chatModel!.additionalData["discountData"]["customerBogo"]["buy"]["quantity"]}",
            style: TextStyle(
              fontSize: fontSp! * 14,
              color: config.Colors().mainColor(1),
              fontWeight: FontWeight.bold,
          ...
          Wrap(
            ...
            children: [
              Text(
                "Get ${widget.chatModel!.additionalData["discountData"]["customerBogo"]["get"]["quantity"]}",
                style: TextStyle(
                  fontSize: fontSp! * 14,
                  color: config.Colors().mainColor(1),
                  fontWeight: FontWeight.bold,
              ...
              Text(
                widget.chatModel!.additionalData["discountData"]["customerBogo"]["get"]["type"] == AppConfig.discountBuyValueForCoupon[0]["value"]
                    ? "${AppConfig.discountBuyValueForCoupon[0]["text"].toString().toUpperCase()}"
                    : "${widget.chatModel!.additionalData["discountData"]["customerBogo"]["get"]["percentValue"]} %  OFF",
                style: TextStyle(
                  fontSize: fontSp! * 12,
                  color: config.Colors().mainColor(1),
                  fontWeight: FontWeight.bold,
        ...
        Navigator.of(context).push(
          MaterialPageRoute(
            builder: (BuildContext context) => B2BOrderDetailPage(
              orderId: widget.chatModel!.additionalData['orderId'],
              myStoreId: widget.chatModel!.additionalData['myStoreId'],
              businessStoreId: widget.chatModel!.additionalData['businessStoreId'],
            ),
          ),
        );
      },

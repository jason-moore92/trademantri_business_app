...
class ProductInvoiceWidget extends StatefulWidget {
  ...
  @override
  _ProductInvoiceWidgetState createState() => _ProductInvoiceWidgetState();
}
        ...
        if ((widget.productOrderModel!.productModel!.id == null || widget.productOrderModel!.productModel!.id.toString().contains("custom")) &&
          ...
          Row(
            ...
            children: [
              ...
              if (widget.productOrderModel!.couponDiscount == 0 && widget.productOrderModel!.promocodeDiscount == 0)
                Text(

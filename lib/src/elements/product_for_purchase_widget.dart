...
class ProductPuchaseWidget extends StatefulWidget {
  ...
  @override
  _ProductPuchaseWidgetState createState() => _ProductPuchaseWidgetState();
}

class _ProductPuchaseWidgetState extends State<ProductPuchaseWidget> {
  ...
  Widget _productWidget() {
    return Row(
      children: [
        KeicyAvatarImage(
          url: widget.purchaseModel!.productsData![_purchaseItemModel!.productId]!.images!.isEmpty
              ? ""
              : widget.purchaseModel!.productsData![_purchaseItemModel!.productId]!.images![0],
          imageFile: widget.purchaseModel!.productsData![_purchaseItemModel!.productId]!.imageFile,
          width: widthDp * 80,
          height: widthDp * 80,
              ...
              Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: (widget.purchaseModel!.productsData![_purchaseItemModel!.productId]!.quantity == null &&
                                widget.purchaseModel!.productsData![_purchaseItemModel!.productId]!.quantityType == null)
                            ? SizedBox()
                            : Text(
                                "${widget.purchaseModel!.productsData![_purchaseItemModel!.productId]!.quantity ?? ""} ${widget.purchaseModel!.productsData![_purchaseItemModel!.productId]!.quantityType ?? ""}",
              ...
              if (widget.showOrderId) ...[
                ...
                Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      child: Text(
                        widget.purchaseModel!.purchaseOrderId.toString(),
                        style: TextStyle(
                          color: Colors.blue,
                      ...
                      onTap: () {
                        _detailHandler(widget.purchaseModel);
                      },
                    )
                  ],
                ),

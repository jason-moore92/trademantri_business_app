...
import 'package:trapp/src/pages/CustomerRecentOrders/index.dart';
...
class CustomersRecentOrdersWidget extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      user == null ? "${itemsToShow} Recent Orders" : "${itemsToShow} Recent Orders",
                      style: TextStyle(
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (BuildContext context) => CustomerRecentOrdersPage(
                            user: user,
                          ),
                        ),
                      );
            ...
            FutureBuilder<List<OrderModel>>(
                future: customersProvider!.getRecentOrders(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("${cro.userModel!.firstName} ${cro.userModel!.lastName}"),
                                    Text(
                                      cro.orderId!,
                                      style: TextStyle(fontSize: 8.0),
                                    ),

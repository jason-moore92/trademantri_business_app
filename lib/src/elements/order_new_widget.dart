...
class _OrderWidgetState extends State<OrderWidget> {
  ...
  Widget _orderWidget() {
    ...
    for (var i = 0; i < AppConfig.orderStatusData.length; i++) {
      if (widget.orderModel!.status == AppConfig.orderStatusData[i]["id"]) {
      ...
      children: [
          ...
          children: [
            ...
            Row(
              children: [
                GestureDetector(
                  onTap: () async {
                    if (await canLaunch(widget.orderModel!.invoicePdfUrlForStore ?? widget.orderModel!.invoicePdfUrl!)) {
                      await launch(
                        widget.orderModel!.invoicePdfUrlForStore ?? widget.orderModel!.invoicePdfUrl!,
                        forceSafariVC: false,
                        forceWebView: false,
                      );
                    } else {
                      throw 'Could not launch ${widget.orderModel!.invoicePdfUrlForStore ?? widget.orderModel!.invoicePdfUrl}';
                    }
                  },
                ...
                GestureDetector(
                  onTap: () {
                    Share.share(widget.orderModel!.invoicePdfUrlForStore ?? widget.orderModel!.invoicePdfUrl!);
                  },
                  child: Image.asset(
                    "img/share-icon.png",
                    width: heightDp * 30,
        ...
        Row(
          ...
          children: [
            ...
            Text(
              "${widget.orderModel!.userModel!.firstName} ${widget.orderModel!.userModel!.lastName}",
              style: TextStyle(fontSize: fontSp * 14, color: Colors.black),
            ),
          ],
        ),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: heightDp * 5),
                                  widget.orderModel!.deliveryAddress!.building == null || widget.orderModel!.deliveryAddress!.building == ""
                                      ? SizedBox()
                                      : Column(
                                          children: [
                                            Text(
        ...
        else if (widget.orderModel!.status == AppConfig.orderStatusData[2]["id"])
          _acceptedOrderButtonGroup()
        else if (widget.orderModel!.status == AppConfig.orderStatusData[3]["id"])
          _paidOrderButtonGroup()
        else if (widget.orderModel!.status == AppConfig.orderStatusData[4]["id"] || widget.orderModel!.status == AppConfig.orderStatusData[5]["id"])
  ...
  Widget _paidOrderButtonGroup() {
    return Container(
      ...
      child: Wrap(
        ...
        children: [
          if (!widget.orderModel!.pickupDeliverySatus! && widget.orderModel!.orderType != "Service")
            Row(
              ...
              children: [
                KeicyRaisedButton(
                  ...
                  padding: EdgeInsets.symmetric(horizontal: widthDp * 5),
                  child: Text(
                    widget.orderModel!.orderType == "Pickup" ? "Change Pick Date" : "Change Delivery Status",
                    style: TextStyle(fontSize: fontSp * 12, color: Colors.white),
                  ),
                  onPressed: () {
                ...
                KeicyRaisedButton(
                  ...
                  padding: EdgeInsets.symmetric(horizontal: widthDp * 5),
                  child: Text(
                    widget.orderModel!.orderType == "Pickup" ? "Pickup Ready" : "Delivery Ready",
                    style: TextStyle(fontSize: fontSp * 12, color: Colors.white),
                  ),
                  onPressed: () {
                    if (widget.orderModel!.orderType == "Pickup") {
  ...
  Widget _acceptedOrderButtonGroup() {
    return Column(
      children: [
        if (widget.orderModel!.orderType != "Service")
          Row(
            mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: [
              KeicyRaisedButton(
          ...
          SizedBox(),
        if (widget.orderModel!.orderType != "Service") SizedBox(height: heightDp * 10) else SizedBox(),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
          children: [
  ...
  Widget _pickupCompleteButtonGroup() {
    return Container(
      ...
      child: Wrap(
        ...
        runSpacing: heightDp * 10,
        children: [
          if (widget.orderModel!.payStatus!)
            KeicyRaisedButton(
              width: widthDp * 170,
              height: heightDp * 30,
              color: config.Colors().mainColor(1),
              ...
              padding: EdgeInsets.symmetric(horizontal: widthDp * 5),
              child: Text(
                widget.orderModel!.orderType == "Pickup" ? "Pickup Order Complete" : "Delivery Order Complete",
                style: TextStyle(fontSize: fontSp * 12, color: Colors.white),
              ),
              onPressed: widget.completeCallback,
            ),
          if (!widget.orderModel!.payStatus! && (widget.orderModel!.payAtStore! || widget.orderModel!.cashOnDelivery!))
            KeicyRaisedButton(
              width: widthDp * 170,
              height: heightDp * 30,
              color: config.Colors().mainColor(1),
